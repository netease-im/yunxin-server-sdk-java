...
/**
 * Response for querying conversation messages with pagination
 * 
 * API: GET https://open.yunxinapi.com/im/v2/conversations/{conversation_id}/messages
 */
public class QueryConversationMessagesResponseV2 {
    ...
    /**
     * Class representing a message item in conversation
     */
