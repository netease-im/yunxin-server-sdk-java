...
public class SuperTeamMuteTlistRequestV1 {
    ...
    /**
     * 需要禁言的群成员账号，JSONArray 对应的 accid，最大长度 1024 位字符，一次最多禁言 10 人
     */
    @YunxinParam("muteAccids")
    private String muteAccids;
    ...
    public String getMuteAccids() {
        return muteAccids;
    }

    public void setMuteAccids(String muteAccids) {
