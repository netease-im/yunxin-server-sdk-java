...
/**
 * Request for batch sending messages to a chatroom
 */
public class BatchSendChatroomMessagesRequestV2 {
    ...
    /**
     * ID of the account sending the messages
     */
    @JSONField(name = "sender_id")
    private String senderId;
    
    /**
     * List of account IDs to receive the messages (for direct messages)
    ...
    /**
     * Flag to indicate if these are resend messages
