...
public class BatchSendP2PMessageRequestV2 {
    ...
    public static class AntispamConfig {
        /**
         * Whether message should be checked by antispam (default: true if antispam is enabled for the app)
         */
        ...
        /**
         * Antispam extension (JSON format, max 1024 characters)
         */
        @JSONField(name = "antispam_extension")
        private String antispamExtension;

        /**
         * Antispam cheating parameters (JSON format, max 1024 characters)
         */
    ...
    public static class P2POption {
        /**
         * Whether message can only be sent to friends (default: false)
         */
