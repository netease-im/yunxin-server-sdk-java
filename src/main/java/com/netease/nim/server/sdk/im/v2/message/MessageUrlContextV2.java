...
public class MessageUrlContextV2 {
     ...
     */
    static final String QUERY_MESSAGE = "/im/v2/conversations/{conversation_id}/messages/{message_server_id}";
    
    /**
     * Search messages endpoint
     */
    static final String SEARCH_MESSAGES = "/im/v2/messages/actions/search_messages";
    
    /**
     * Query conversation messages with pagination endpoint
     */
    static final String QUERY_CONVERSATION_MESSAGES = "/im/v2/conversations/{conversation_id}/messages";
    
    /**
     * Batch query messages by message IDs endpoint
     */
    static final String BATCH_QUERY_MESSAGES = "/im/v2/conversations/{conversation_id}/batch_messages";
    
    /**
     * Query thread messages endpoint
     */
    static final String QUERY_THREAD_MESSAGES = "/im/v2/messages/actions/thread_messages";
