...
public class SearchMessagesResponseV2 {

    @JSONField(name = "count")
    private Integer count;                // Total number of messages found
    ...
    private List<MessageItem> items;      // List of found messages
    ...
    public static class MessageItem {
        ...
        private QueryThreadMessagesResponseV2.ThreadConfig threadConfig;
