...
public class ChatroomMemberV2UrlContext {
     ...
     */
    static final String QUERY_CHATROOM_BLACKLIST = "/im/v2.1/room_members/{room_id}/actions/blocked";
     ...
     */
    static final String QUERY_VIRTUAL_MEMBERS = "/im/v2.1/room_members/actions/virtual_members";
