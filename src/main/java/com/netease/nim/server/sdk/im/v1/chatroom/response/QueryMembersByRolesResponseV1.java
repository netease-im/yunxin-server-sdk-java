 ...
 */
public class QueryMembersByRolesResponseV1 {

    private List<QueryMembersByRoles> data;

    public List<QueryMembersByRoles> getData() {
        return data;
    }

    public void setData(List<QueryMembersByRoles> data) {
        this.data = data;
    }

    public static class QueryMembersByRoles {
