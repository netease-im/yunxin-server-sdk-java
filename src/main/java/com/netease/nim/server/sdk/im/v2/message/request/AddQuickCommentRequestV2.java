...
/**
 * Request for adding quick comment to a message
 * 
 * API: PATCH https://open.yunxinapi.com/im/v2/messages/actions/quick_comment
 */
public class AddQuickCommentRequestV2 {
    
    @JSONField(name = "operator_id")
    private String operatorId;            // 必选: 进行添加快捷评论操作的用户账号 ID
     ...
     * 默认构造函数
     */
    public AddQuickCommentRequestV2() {
    }
     ...
     */
    public AddQuickCommentRequestV2(String operatorId, Long index, Message message) {
     ...
     */
    public AddQuickCommentRequestV2(String operatorId, Long index, String extension, 
