...
public interface IMessageV2Service {
     ...
     *
     * @param request The request object for sending a streaming message.
     * @return The result of the operation.
     * @throws YunxinSdkException if the API call fails.
     */
    Result<StreamMessageResponseV2> streamMessage(StreamMessageRequestV2 request) throws YunxinSdkException;
     ...
     * @throws IllegalArgumentException if request parameters are invalid
     */
    Result<QueryMessagesByPageResponseV2> queryMessagesByPage(
