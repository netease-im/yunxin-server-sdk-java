...
public class FriendV2UrlContext {
     ...
     */
    static final String FRIENDS = "/im/v2.1/friends";
     ...
     */
    static final String UPDATE_FRIEND = "/im/v2.1/friends/{account_id}";
    
    /**
     * Get friend endpoint
     */
    static final String GET_FRIEND = "/im/v2.1/friends/{account_id}";
    
    /**
     * List friends endpoint
     */
    static final String LIST_FRIENDS = "/im/v2.1/friends";
    
    /**
     * Handle friend addition endpoint (accept/reject)
     */
    static final String HANDLE_FRIEND_ADDITION = "/im/v2.1/friends/actions/handle_friend_addition";
} 