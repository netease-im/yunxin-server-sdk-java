...
public class QueryTeamReadReceiptRequestV2 {
     ...
     */
    public QueryTeamReadReceiptRequestV2(Long teamId, String senderId, Long messageServerId) {
        this.teamId = teamId;
     ...
     */
    public QueryTeamReadReceiptRequestV2(Long teamId, String senderId, Long messageServerId, Boolean snapshot) {
        this.teamId = teamId;
        this.teamType = 1;  // Currently only supports advanced team
        this.senderId = senderId;
        this.messageServerId = messageServerId;
