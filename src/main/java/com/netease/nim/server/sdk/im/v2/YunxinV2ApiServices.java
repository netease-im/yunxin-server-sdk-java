...
import com.netease.nim.server.sdk.im.v2.ai.AiService;
import com.netease.nim.server.sdk.im.v2.ai.IAiSerivce;
...
import com.netease.nim.server.sdk.im.v2.tool.ToolV2Service;
...
public class YunxinV2ApiServices {
    ...
    public IAiSerivce getAiService() {
        return aiService;
    }

    public IToolV2Service getToolService() {
        return toolService;
    }
