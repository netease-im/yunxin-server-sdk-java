...
public class ConversationV2UrlContext {
     ...
     */
    static final String CREATE_CONVERSATION = "/im/v2.1/conversations";
    /**
     ...
     */
    static final String GET_CONVERSATION = "/im/v2.1/conversations/{conversation_id}";
    /**
     * Batch get conversations endpoint
     */
    static final String BATCH_GET_CONVERSATIONS = "/im/v2.1/conversations/actions/conversation_ids";
    /**
     * List conversations endpoint (paginated)
     */
    static final String LIST_CONVERSATIONS = "/im/v2.1/conversations";
    /**
