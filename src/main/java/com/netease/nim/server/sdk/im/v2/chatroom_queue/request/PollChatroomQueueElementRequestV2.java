...
/**
 * Request for polling an element from a chatroom queue
 * 
...
public class PollChatroomQueueElementRequestV2 {
    ...
    /**
     * Element key to poll
     * If not provided, the first element in the queue will be polled
    ...
    /**
     * Constructor with roomId and elementKey
     * 
     * @param roomId chatroom ID
     * @param elementKey element key to poll
     */
    ...
    /**
     * Get element key to poll
     * 
     * @return element key to poll
     */
