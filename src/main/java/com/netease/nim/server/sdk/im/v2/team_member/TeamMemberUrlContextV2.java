...
public class TeamMemberUrlContextV2 {
     ...
     */
    public static final String UPDATE_TEAM_MEMBER = "/im/v2/team_members/{account_id}";
     ...
     */
    public static final String JOINED_TEAMS = "/im/v2/team_members/{account_id}/actions/joined_teams";
} 