...
public class TestFriendV1 {
    ...
    private static void add() {
        ...
        Result<AddFriendResponseV1> result = friendV1Service.add(request);
    ...
    private static void update() {
        ...
        Result<UpdateFriendResponseV1> result = friendV1Service.update(request);
        Assert.assertTrue(result.getCode() + ":" + result.getMsg(), result.isSuccess());
    ...
    private static void delete() {
        ...
        Result<DeleteFriendResponseV1> result = friendV1Service.delete(request);
        Assert.assertTrue(result.getCode() + ":" + result.getMsg(), result.isSuccess());
