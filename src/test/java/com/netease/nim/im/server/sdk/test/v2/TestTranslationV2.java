...
public class TestTranslationV2 {
    ...
    public void testChineseToEnglishTranslation() throws Exception {
        ...
        try {
            ...
            ITranslationV2Service translationService = services.getTranslationService();
            ...
            // Perform translation
            Result<TranslateTextResponseV2> zhToEnResult = translationService.translateText(zhToEnRequest);
