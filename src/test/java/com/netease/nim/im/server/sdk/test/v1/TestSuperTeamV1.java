...
public class TestSuperTeamV1 {
    ...
    public void testChangeLevel() {
        ...
        try {
            ...
            Result<SuperTeamChangeLevelResponseV1> result = superTeamV1Service.changeLevel(request);
    ...
    public void testUpdateTinfo() {
        ...
        try {
            ...
            Result<SuperTeamUpdateResponseV1> result = superTeamV1Service.updateTinfo(request);
    ...
    public void testInviteAndUpdateNick() {
        ...
        try {
            ...
            request.setInviteAccids(Arrays.asList(member));
            ...
            Result<SuperTeamUpdateNickResponseV1> nickResult = superTeamV1Service.updateTeamNick(nickRequest);
    ...
    public void testLeaveAndKick() {
        ...
        try {
            ...
            request.setTid(tid);
            Result<SuperTeamMemberLeaveResponseV1> result = superTeamV1Service.leave(request);
            ...
            Result<SuperTeamKickMemberResponseV1> kickResult = superTeamV1Service.kick(kickRequest);
    ...
    public void testUpdateTlist() {
        ...
        try {
            ...
            request.setTid(tid);
            Result<SuperTeamUpdateMemberInfoResponseV1> result = superTeamV1Service.updateTlist(request);
    ...
    public void testSendAndQueryMessage() {
        ...
        try {
            ...
            // 撤回消息
            RecallSuperTeamMessageRequestV1 recallRequest = new RecallSuperTeamMessageRequestV1();
            ...
            Result<RecallSuperTeamMessageResponseV1> recallResult = superTeamV1Service.recallMsg(recallRequest);
    ...
    public void testSendAttachMsg() {
        ...
        try {
            ...
            Result<SendAttachSuperTeamMessageResponseV1> result = superTeamV1Service.sendAttachMsg(request);
